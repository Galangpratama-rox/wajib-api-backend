...
const kuramanimeScraper = {
    ...
    async _doScrapeEpisode(episodeUrl, animeId, animeSlug) {
        ...
        if (hasProxyKeys()) {
            ...
            try {
                const html = await Promise.race([
                    ...
                    new Promise((_, reject) => setTimeout(() => reject(new Error("ScraperAPI render timeout")), SCRAPER_TIMEOUT_MS)),
                ]);
