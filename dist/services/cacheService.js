 ...
 */
export async function setCached(key, value, ttlSeconds = TTL_DEFAULT, storeStale = false) {
    if (!isReady())
        return;
    try {
...
export async function getStaleCached(key) {
    ...
    try {
        ...
        console.error("[cacheService] getStaleCached error:", err.message);
        return null;
    }
}
/**
...
export async function deleteCached(key) {
    ...
    try {
        ...
        console.error("[cacheService] deleteCached error:", err.message);
    }
}
/**
...
export async function getCacheStats() {
    ...
    try {
        ...
        console.error("[cacheService] getCacheStats error:", err.message);
